...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    late_penalty_text TEXT NOT NULL DEFAULT 'En cas de retard de paiement, une pénalité égale à 3 fois le taux d''intérêt légal sera appliquée, conformément à l''article L.441-10 du Code de commerce.',
    recovery_costs_text TEXT NOT NULL DEFAULT 'Indemnité forfaitaire pour frais de recouvrement : 40 EUR',
    notes TEXT,
    created_at TEXT NOT NULL DEFAULT (datetime('now')),
    updated_at TEXT NOT NULL DEFAULT (datetime('now')),
    finalized_at TEXT
